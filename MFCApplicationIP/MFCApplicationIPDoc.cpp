...
// MFCApplicationIPDoc.cpp: CMFCApplicationIPDoc 클래스의 구현
//
...
// CMFCApplicationIPDoc

IMPLEMENT_DYNCREATE(CMFCApplicationIPDoc, CDocument)

BEGIN_MESSAGE_MAP(CMFCApplicationIPDoc, CDocument)
END_MESSAGE_MAP()


// CMFCApplicationIPDoc 생성/소멸

CMFCApplicationIPDoc::CMFCApplicationIPDoc() noexcept
{
	// TODO: 여기에 일회성 생성 코드를 추가합니다.

}

CMFCApplicationIPDoc::~CMFCApplicationIPDoc()
{
}

BOOL CMFCApplicationIPDoc::OnNewDocument()
{
...
// CMFCApplicationIPDoc serialization

void CMFCApplicationIPDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void CMFCApplicationIPDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMFCApplicationIPDoc::InitializeSearchContent()
{
...
void CMFCApplicationIPDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// CMFCApplicationIPDoc 진단

#ifdef _DEBUG
void CMFCApplicationIPDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CMFCApplicationIPDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
// CMFCApplicationIPDoc 명령

BOOL CMFCApplicationIPDoc::OnOpenDocument(LPCTSTR lpszPathName)
{
